...
| What is it, exactly? | text dump — `arris_debug::dump_text(&model, shape)` (M2) | Entities, ids, orientations, geometry parameters, tolerances, pcurves; deterministic, diffable, what a fixture stores. |
