...
fn angle_range() -> impl Strategy<Value = Interval> {
    (
        finite_f64(-7.0..=7.0),
...
fn line_range() -> impl Strategy<Value = Interval> {
...
fn latitude_range() -> impl Strategy<Value = Interval> {
    (
...
fn locate(surface: &Surface, p: Point3) -> Located {
